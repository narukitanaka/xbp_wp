  ...
  <div class="p-under p-archive_press p-archive">
    ...
    <div class="inner">
      ...
      <div class="cate-list flex">
        <a class="<?php echo (is_post_type_archive('press')) ? 'active' : ''; ?>" href="<?php echo get_post_type_archive_link('press'); ?>">All</a>
        <?php
        ...
        ?>
          <a class="<?php echo (is_tax('press-cat', $category->slug)) ? 'active' : ''; ?>" href="<?php echo get_term_link($category); ?>"><?php echo $category->name; ?></a>
        <?php
          endforeach;
          endif;
        ?>
